let table = $("#datatable").DataTable({
    ajax: {
        url: baseUrl("/api/administrator/frontend/about-project" + "-fetch"),
        dataSrc: "data",
        type: "POST",
    },
    processing: true,
    ...
    createdRow: function (row, data) {
        ...
        $(".action-detail", row).click(function (e) {
            ...
            window.location.replace(
                baseUrl("/administrator/frontend/about-project-item/" + data.id)
            );
        });
        ...
        $(".action-edit", row).click(function (e) {
            ...
            $('input[name="nama"]').val(data.about_project_nama);
            $(".image-preview").attr(
                "src",
                data.about_project_img
                    ? assetsUrl(
                          "uploads/about-project/" + data.about_project_img
                      )
                    : assetsUrl("uploads/about-project/no-image.png")
            );
        ...
        $(".action-hapus", row).click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.httpRequest({
                        url: baseUrl(
                            "/api/administrator/frontend/about-project/" +
                                data.id
                        ),
                        method: "DELETE",
                        response: (res) => {

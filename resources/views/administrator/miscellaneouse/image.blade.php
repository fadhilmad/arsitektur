    ...
    <div id="modal-form" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form id="form-data" action="{{ url('api/administrator/miscellaneouse-image') }}" method="post">
                    <input type="hidden" name="id">
                    <input type="hidden" name="miscellaneouse_id">
                    <div class="modal-header d-flex">
                        <h5 class="modal-title">Foto Miscellaneouse Form</h5>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="alamat">Foto Miscellaneouse</label>
                                    <div class="card card-upload-image on-hover">
                                        <div class="card-body text-center">
                                            <img class="image-preview" src="{{ url('/uploads/miscellaneouse/no-image.png') }}"
                                                alt="no-image.png">
                                        </div>
                                    </div>
...
@section('javascript')
    ...
    <script src="{{ asset('/assets/administrator/utils/administrator/miscellaneouse-image.js') }}"></script>
@endsection

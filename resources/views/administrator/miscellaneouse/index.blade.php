        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-btn d-flex justify-content-between">
                    <h4 class="card-title">
                        <i class="nc-icon nc-ruler-pencil mr-1"></i> Miscellaneouse
                    </h4>
    ...
    <div id="modal-form" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <form id="form-data" action="{{ url('api/administrator/miscellaneouse') }}" method="post">
                    <input type="hidden" name="id">
                    <div class="modal-header d-flex">
                        <h5 class="modal-title">Miscellaneouse Form</h5>
                        ...
                        <div class="row">
                                    ...
                                    <div class="card card-upload-image on-hover">
                                        <div class="card-body text-center">
                                            <img class="image-preview"
                                                src="{{ url('/uploads/miscellaneouse/no-image.png') }}" alt="no-image.png">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="nama-miscellaneouse">Nama Miscellaneouse</label>
                                            <input type="text" class="form-control" name="nama"
                                                id="nama-miscellaneouse" placeholder="Nama Miscellaneouse">
...
@section('javascript')
    <script src="{{ asset('/assets/administrator/utils/administrator/miscellaneouse.js') }}"></script>
@endsection

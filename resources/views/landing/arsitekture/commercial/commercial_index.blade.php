			...
			<div class="col-lg-9 text-center mt-5">
				...
				<nav aria-label="breadcrumb" data-aos="fade-up" data-aos-delay="200">
					<ol class="breadcrumb text-center justify-content-center">
						...
						<li class="breadcrumb-item active text-white-50" aria-current="page">Commercial</li>
					</ol>
				</nav>
			</div>
		</div>
        ...
        <div class="row justify-content-between">
			<div class="col-lg-7 ">
				<div class="vidio-discripsi">
					<div class="col">
						<h2 class="heading text-primary mb-3">Commercial</h2>
						<div class="text">
							<p class="meta">Descripsi Commercial</p>

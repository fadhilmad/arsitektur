...
<div class="section">
    <div class="container">
        <div class="row mb-5 align-items-center">
            <div class="col-lg-6">
                <h2 class="font-weight-bold text-primary heading">Popular Project</h2>
            </div>
            <div class="col-lg-6 text-lg-end">
                <p><a href="#" target="_blank" class="btn btn-primary text-white py-3 px-4">View all Project</a></p>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
        ...
        <div class="row">
            <div class="col-6 col-lg-3"  data-aos="fade-up" data-aos-delay="300">
                <div class="box-feature">
                    ...
                    <h3 class="mb-3">GENERAL CONTRACTOR</h3>
                    <p>Bidang usaha meliputi : civil, electrical & instrument, structure, mechanical, dan piping.</p>
            ...
            <div class="col-6 col-lg-3"  data-aos="fade-up" data-aos-delay="500">
                <div class="box-feature">
                    ...
                    <p>Bidang  usaha  meliputi  :  pengadaan  material  konstruksi  yang  berkualitas  dan  harga  yang  kami tawarkan adalah yang terbaik. Bidang  usaha  jasa dimana  sebuah  perusahaan  penyalur  tenaga  kerja  yang  siap  pakai  dan  sesuai  standarisasi kebutuhan  perusahaan.</p>
                    <p><a href="#" class="learn-more">Learn More</a></p>
                </div>
            </div>
            <div class="col-6 col-lg-3"  data-aos="fade-up" data-aos-delay="400">
                <div class="box-feature">
                    ...
                    <p>Bidang usaha meliputi : bidang arsitektur, bidang analisa dan perhitungan RAB serta manajemen proyek.</p>
                    <p><a href="#" class="learn-more">Learn More</a></p>
                </div>
            </div>
            <div class="col-6 col-lg-3"  data-aos="fade-up" data-aos-delay="600">
                <div class="box-feature">
                    ...
                    <h3 class="mb-3">MAINTENANCE SERVICE</h3>
                    <p>Bidang usaha meliputi : perawatan berkala dan rutin.</p>
                    <p><a href="#" class="learn-more">Learn More</a></p>
                </div>
            </div>	
        </div>
...
<div class="section section-4 bg-light">
    <div class="container">
        <div class="row justify-content-center  text-center mb-5">
            <div class="col-lg-5">
                <h2 class="font-weight-bold heading text-primary mb-4">Architecture Principles </h2>
                <p class="text-black-50">Web Architecture principles help to design technologies by providing guidance and articulating the issues around some specific choices.</p>
            </div>
        </div>
...
<div class="section">
    <div class="row justify-content-center footer-cta" data-aos="fade-up">
        <div class="col-lg-7 mx-auto text-center">
            <h2 class="mb-4 ">If you need help contact us</h2>
            <p><a href="/contact" class="btn btn-primary text-white py-3 px-4">Contact us</a></p>
        </div> <!-- /.col-lg-7 -->
    </div> <!-- /.row -->
</div>
@endsection
